...
Canonical URL: https://docs.x.ai/grok-bot/overview
Fetched: 2026-08-30
...
The computer is isolated to your account, not to an individual Bot. Treat a login or file placed on the computer as available to all of your Bots. Each Bot gets its own screen on that computer, so several Bots can use browser and desktop tools in parallel without getting separate security boundaries.
...
This tells the Bot what to do, where to work, what context to pull in, what you'd like to see as a finished deliverable.

You can review a Bot's work, provide corrections, and turn the process into a reusable skill or proactive routine.

## What to explore next

- Get started with the desktop app and your first Bot.
- Discover more use cases for Bots.
- Make recurring work repeatable with skills and routines.
- Learn how to use the computer and apps.
- Review approvals, security, and privacy before granting access to sensitive systems.
